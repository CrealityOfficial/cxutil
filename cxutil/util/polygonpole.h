...
namespace polygonPole {
    ...
    */
    ...
    template <typename T>
    Cell<T> GetIterationCircles(Polygon<T>& polys, cxutil::LightOffCircle& result, cxutil::LightOffDebugger* debugger = nullptr,
    ...
    template <typename T>
    Cell<T> GetIterationCircleRoutes(Polygon<T>& polys, cxutil::LightOffCircle& result, cxutil::LightOffDebugger* debugger = nullptr,
        ccglobal::Tracer* tracer = nullptr)
    {
        polys.Simplify();
        if (polys.IsRectangle()) {
